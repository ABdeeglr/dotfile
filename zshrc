...
export VSCODE_PATH=/opt/VSCode-linux-x64/
...
alias sai="sudo pacman -S --needed"
alias ccc="clear"
pypi_tuna=https://pypi.tuna.tsinghua.edu.cn/simple
alias gtr="git log --oneline --graph --decorate --all"
[ -f "/home/ramsay/.ghcup/env" ] && source "/home/ramsay/.ghcup/env" # ghcup-env
alias ml="make && make love"
alias gvv="riscv64-linux-gnu-gcc"
alias yay="paru"
